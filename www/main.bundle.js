...
var map = {
	"./components/addpost/addpost.module": [
	...
	"./components/singlepost/singlepost.module": [
...
var AppComponent = (function () {
    function AppComponent(postService) {
        ...
        this.uniqPost = { title: null, content: null };
    }
    ;
    AppComponent.prototype.addPost = function () {
        this.postService.addPost(this.uniqPost).then(function (data) {
            console.log(data);
        }).catch(function (err) {
            console.log(err);
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__partials_header_header_component__ = __webpack_require__("../../../../../src/app/partials/header/header.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__partials_footer_footer_component__ = __webpack_require__("../../../../../src/app/partials/footer/footer.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__partials_header_header_component__["a" /* HeaderComponent */],
                __WEBPACK_IMPORTED_MODULE_7__partials_footer_footer_component__["a" /* FooterComponent */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_2__angular_http__["c" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_5__app_routes__["a" /* Routing */]
            ],
            providers: [],
...
var Routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forRoot(route);
...
module.exports = "<header>\n  <nav>\n    <ul>\n      <li><a routerLink='/'>Accueil</a></li>\n      <li><a routerLink='/addpost'>Ajouter un post</a></li>\n    </ul>\n  </nav>\n</header>"
...
var PostService = (function () {
    function PostService(http) {
        this.http = http;
        this.apiUrl = "http://localhost:3000/api/post";
    }
    ;
    // Fonction pour ajouter un post
    PostService.prototype.addPost = function (postData) {
    ...
    PostService.prototype.getData = function (res) {
        return res.json() || {};
    };
    ;
